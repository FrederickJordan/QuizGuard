...
const questionBank = {
  ...
  math: {
    ...
    medium: [
      { question: "12² = ?", answers: ["124","132","144","154"], correct: 2 },
      { question: "π (2dp)?", answers: ["3.12","3.14","3.16","3.18"], correct: 1 },
    ...
    hard: [
      ...
      { question: "2x+6=18", answers: ["4","5","6","7"], correct: 2 },
      { question: "sin(90°)?", answers: ["0","0.5","1","-1"], correct: 2 },
      { question: "log10(100)?", answers: ["1","2","10","100"], correct: 1 }
    ]
  },
  ...
  english: {
    ...
    medium: [
      ...
      { question: "Correct sentence?", answers: ["She go","She goes","She going","She gone"], correct: 1 },
...
function startCupGame() {
  ...
  document.querySelectorAll(".cup").forEach((c, i) => {
    c.onclick = () => {
      i === cupIndex ? log("Correct cup") : penalty("Wrong cup");
      shuffle();
    };
  });
...
function startQTE() {
  ...
  $("gameArea").innerHTML = `
    <div id="tk"></div>
    <div class="gauge"><div id="gf"></div></div>
  `;
